...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_usuario_idusuario_label" id="hidden_field_label_usuario_idusuario" style="<?php echo $sStyleHidden_usuario_idusuario; ?>"><span id="id_label_usuario_idusuario"><?php echo $this->nm_new_label['usuario_idusuario']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos']['php_cmp_required']['usuario_idusuario']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_vehiculos']['php_cmp_required']['usuario_idusuario'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
