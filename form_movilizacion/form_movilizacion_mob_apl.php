...
//----- 
   function ini_controle()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['where_orig'] = " where IdVehiculo = (Select IdVehiculo from vehiculos where usuario_idusuario = " . $_SESSION['id_usuario_movilizacion'] . ")";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['where_pesq'] = " where IdVehiculo = (Select IdVehiculo from vehiculos where usuario_idusuario = " . $_SESSION['id_usuario_movilizacion'] . ")";
...
//
   ...
   function loadFieldConfig()
   {
      ...
      $this->field_config['movilizacion_hora_salida']['date_display'] = "hhiiss";
      ...
      $this->field_config['movilizacion_hora_llegada']['date_display'] = "hhiiss";
   ...
   function Recupera_Nome_Campo($campo) 
   {
       switch($campo)
       {
           ...
           case 'movilizacion_recorrido_vehiculo':
               return "Recorrido por el Vehículo";
               break;
    ...
    function ValidateField_id_movilizacion(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              { 
                  $Campos_Crit .= "Id Movilizacion: " . $this->Ini->Nm_lang['lang_errm_size']; 
    ...
    function ValidateField_movilizacion_recorrido_vehiculo(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              { 
                  $Campos_Crit .= "Recorrido por el Vehículo: " . $this->Ini->Nm_lang['lang_errm_size']; 
              ...
              { 
                  $Campos_Crit .= "Recorrido por el Vehículo; " ; 
                  if (!isset($Campos_Erros['movilizacion_recorrido_vehiculo']))
                  {
                      $Campos_Erros['movilizacion_recorrido_vehiculo'] = array();
                  }
...
else
{
   ...
   $nm_comando = "SELECT IdVehiculo, Concat(usuario_nombres,' ',usuario_apellidos,'---Vehiculo: ',vehiculos.Vehiculo_Modelo,'---Placa: ',vehiculos.Vehiculo_Placa)   FROM usuario, vehiculos where usuario.idusuario = vehiculos.usuario_idusuario and IdVehiculo = (Select IdVehiculo from vehiculos where usuario_idusuario = " . $_SESSION['id_usuario_movilizacion'] . ")";
...
$_SESSION['scriptcase']['form_movilizacion_mob']['contr_erro'] = 'off'; 
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          { 
              ...
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
              { 
                  $comando = "UPDATE " . $this->Ini->nm_tabela . " SET movilizacion_funcionario = '$this->movilizacion_funcionario', Movilizacion_Fecha = #$this->movilizacion_fecha#, Movilizacion_Hora_Salida = #$this->movilizacion_hora_salida#, Movilizacion_Hora_Llegada = #$this->movilizacion_hora_llegada#, Movilizacion_Km_Salida = $this->movilizacion_km_salida, Movilizacion_Km_Llegada = $this->movilizacion_km_llegada, Movilizacion_Costo_Galon = $this->movilizacion_costo_galon, Movilizacion_Total_Km_Recorrido = $this->movilizacion_total_km_recorrido, movilizacion_Recorrido_Vehiculo = $this->movilizacion_recorrido_vehiculo, movilizacion_Excedente = $this->movilizacion_excedente, Movilizacion_Total_Galones = $this->movilizacion_total_galones, IdVehiculo = $this->idvehiculo";  
              } 
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
              { 
                  $comando = "UPDATE " . $this->Ini->nm_tabela . " SET movilizacion_funcionario = '$this->movilizacion_funcionario', Movilizacion_Fecha = " . $this->Ini->date_delim . $this->movilizacion_fecha . $this->Ini->date_delim1 . ", Movilizacion_Hora_Salida = " . $this->Ini->date_delim . $this->movilizacion_hora_salida . $this->Ini->date_delim1 . ", Movilizacion_Hora_Llegada = " . $this->Ini->date_delim . $this->movilizacion_hora_llegada . $this->Ini->date_delim1 . ", Movilizacion_Km_Salida = $this->movilizacion_km_salida, Movilizacion_Km_Llegada = $this->movilizacion_km_llegada, Movilizacion_Costo_Galon = $this->movilizacion_costo_galon, Movilizacion_Total_Km_Recorrido = $this->movilizacion_total_km_recorrido, movilizacion_Recorrido_Vehiculo = $this->movilizacion_recorrido_vehiculo, movilizacion_Excedente = $this->movilizacion_excedente, Movilizacion_Total_Galones = $this->movilizacion_total_galones, IdVehiculo = $this->idvehiculo";  
              } 
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_oracle))
              { 
          ...
          $this->detalle_movilizacion = $this->detalle_movilizacion_before_qstr;
              ...
              $this->nmgp_refresh_fields = array_diff(array('id_movilizacion', 'idvehiculo', 'movilizacion_funcionario', 'movilizacion_fecha', 'movilizacion_hora_salida', 'movilizacion_hora_llegada', 'movilizacion_km_salida', 'movilizacion_km_llegada', 'movilizacion_costo_galon', 'movilizacion_total_km_recorrido', 'movilizacion_recorrido_vehiculo', 'movilizacion_excedente', 'movilizacion_total_galones', 'detalle_movilizacion'), $aDoNotUpdate);
              $this->ajax_return_values();
      ...
      { 
          ...
          { 
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
              { 
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (movilizacion_funcionario, Movilizacion_Fecha, Movilizacion_Ruta, Movilizacion_Hora_Salida, Movilizacion_Hora_Llegada, Movilizacion_Km_Salida, Movilizacion_Km_Llegada, Movilizacion_Costo_Galon, Movilizacion_Total_Km_Recorrido, movilizacion_Recorrido_Vehiculo, movilizacion_Excedente, Movilizacion_Total_Galones, IdVehiculo) VALUES ('$this->movilizacion_funcionario', #$this->movilizacion_fecha#, '$this->movilizacion_ruta', #$this->movilizacion_hora_salida#, #$this->movilizacion_hora_llegada#, $this->movilizacion_km_salida, $this->movilizacion_km_llegada, $this->movilizacion_costo_galon, $this->movilizacion_total_km_recorrido, $this->movilizacion_recorrido_vehiculo, $this->movilizacion_excedente, $this->movilizacion_total_galones, $this->idvehiculo)"; 
              }
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
              { 
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (" . $NM_cmp_auto . "movilizacion_funcionario, Movilizacion_Fecha, Movilizacion_Ruta, Movilizacion_Hora_Salida, Movilizacion_Hora_Llegada, Movilizacion_Km_Salida, Movilizacion_Km_Llegada, Movilizacion_Costo_Galon, Movilizacion_Total_Km_Recorrido, movilizacion_Recorrido_Vehiculo, movilizacion_Excedente, Movilizacion_Total_Galones, IdVehiculo) VALUES (" . $NM_seq_auto . "'$this->movilizacion_funcionario', " . $this->Ini->date_delim . $this->movilizacion_fecha . $this->Ini->date_delim1 . ", '$this->movilizacion_ruta', " . $this->Ini->date_delim . $this->movilizacion_hora_salida . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->movilizacion_hora_llegada . $this->Ini->date_delim1 . ", $this->movilizacion_km_salida, $this->movilizacion_km_llegada, $this->movilizacion_costo_galon, $this->movilizacion_total_km_recorrido, $this->movilizacion_recorrido_vehiculo, $this->movilizacion_excedente, $this->movilizacion_total_galones, $this->idvehiculo)"; 
              }
              ...
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_informix))
              {
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (" . $NM_cmp_auto . "movilizacion_funcionario, Movilizacion_Fecha, Movilizacion_Ruta, Movilizacion_Hora_Salida, Movilizacion_Hora_Llegada, Movilizacion_Km_Salida, Movilizacion_Km_Llegada, Movilizacion_Costo_Galon, Movilizacion_Total_Km_Recorrido, movilizacion_Recorrido_Vehiculo, movilizacion_Excedente, Movilizacion_Total_Galones, IdVehiculo) VALUES (" . $NM_seq_auto . "'$this->movilizacion_funcionario', EXTEND('$this->movilizacion_fecha', YEAR TO DAY), '$this->movilizacion_ruta', " . $this->Ini->date_delim . $this->movilizacion_hora_salida . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->movilizacion_hora_llegada . $this->Ini->date_delim1 . ", $this->movilizacion_km_salida, $this->movilizacion_km_llegada, $this->movilizacion_costo_galon, $this->movilizacion_total_km_recorrido, $this->movilizacion_recorrido_vehiculo, $this->movilizacion_excedente, $this->movilizacion_total_galones, $this->idvehiculo)"; 
              }
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
              {
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (" . $NM_cmp_auto . "movilizacion_funcionario, Movilizacion_Fecha, Movilizacion_Ruta, Movilizacion_Hora_Salida, Movilizacion_Hora_Llegada, Movilizacion_Km_Salida, Movilizacion_Km_Llegada, Movilizacion_Costo_Galon, Movilizacion_Total_Km_Recorrido, movilizacion_Recorrido_Vehiculo, movilizacion_Excedente, Movilizacion_Total_Galones, IdVehiculo) VALUES (" . $NM_seq_auto . "'$this->movilizacion_funcionario', " . $this->Ini->date_delim . $this->movilizacion_fecha . $this->Ini->date_delim1 . ", '$this->movilizacion_ruta', " . $this->Ini->date_delim . $this->movilizacion_hora_salida . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->movilizacion_hora_llegada . $this->Ini->date_delim1 . ", $this->movilizacion_km_salida, $this->movilizacion_km_llegada, $this->movilizacion_costo_galon, $this->movilizacion_total_km_recorrido, $this->movilizacion_recorrido_vehiculo, $this->movilizacion_excedente, $this->movilizacion_total_galones, $this->idvehiculo)"; 
...
//------------ 
      ...
      $sc_where = trim("IdVehiculo = (Select IdVehiculo from vehiculos where usuario_idusuario = " . $_SESSION['id_usuario_movilizacion'] . ")");
...
//---------- 
      ...
      { 
          ...
          { 
              $nmgp_select = "SELECT Id_Movilizacion, movilizacion_funcionario, str_replace (convert(char(10),Movilizacion_Fecha,102), '.', '-') + ' ' + convert(char(8),Movilizacion_Fecha,20), Movilizacion_Ruta, str_replace (convert(char(10),Movilizacion_Hora_Salida,102), '.', '-') + ' ' + convert(char(8),Movilizacion_Hora_Salida,20), str_replace (convert(char(10),Movilizacion_Hora_Llegada,102), '.', '-') + ' ' + convert(char(8),Movilizacion_Hora_Llegada,20), Movilizacion_Km_Salida, Movilizacion_Km_Llegada, Movilizacion_Costo_Galon, Movilizacion_Total_Km_Recorrido, movilizacion_Recorrido_Vehiculo, movilizacion_Excedente, Movilizacion_Total_Galones, IdVehiculo from " . $this->Ini->nm_tabela ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
          { 
              $nmgp_select = "SELECT Id_Movilizacion, movilizacion_funcionario, convert(char(23),Movilizacion_Fecha,121), Movilizacion_Ruta, convert(char(23),Movilizacion_Hora_Salida,121), convert(char(23),Movilizacion_Hora_Llegada,121), Movilizacion_Km_Salida, Movilizacion_Km_Llegada, Movilizacion_Costo_Galon, Movilizacion_Total_Km_Recorrido, movilizacion_Recorrido_Vehiculo, movilizacion_Excedente, Movilizacion_Total_Galones, IdVehiculo from " . $this->Ini->nm_tabela ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_oracle))
          { 
              $nmgp_select = "SELECT Id_Movilizacion, movilizacion_funcionario, Movilizacion_Fecha, Movilizacion_Ruta, Movilizacion_Hora_Salida, Movilizacion_Hora_Llegada, Movilizacion_Km_Salida, Movilizacion_Km_Llegada, Movilizacion_Costo_Galon, Movilizacion_Total_Km_Recorrido, movilizacion_Recorrido_Vehiculo, movilizacion_Excedente, Movilizacion_Total_Galones, IdVehiculo from " . $this->Ini->nm_tabela ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_informix))
          { 
              $nmgp_select = "SELECT Id_Movilizacion, movilizacion_funcionario, EXTEND(Movilizacion_Fecha, YEAR TO DAY), Movilizacion_Ruta, Movilizacion_Hora_Salida, Movilizacion_Hora_Llegada, Movilizacion_Km_Salida, Movilizacion_Km_Llegada, Movilizacion_Costo_Galon, Movilizacion_Total_Km_Recorrido, movilizacion_Recorrido_Vehiculo, movilizacion_Excedente, Movilizacion_Total_Galones, IdVehiculo from " . $this->Ini->nm_tabela ; 
          } 
          else 
          { 
              $nmgp_select = "SELECT Id_Movilizacion, movilizacion_funcionario, Movilizacion_Fecha, Movilizacion_Ruta, Movilizacion_Hora_Salida, Movilizacion_Hora_Llegada, Movilizacion_Km_Salida, Movilizacion_Km_Llegada, Movilizacion_Costo_Galon, Movilizacion_Total_Km_Recorrido, movilizacion_Recorrido_Vehiculo, movilizacion_Excedente, Movilizacion_Total_Galones, IdVehiculo from " . $this->Ini->nm_tabela ; 
          ...
          $aWhere = array();
          $aWhere[] = "IdVehiculo = (Select IdVehiculo from vehiculos where usuario_idusuario = " . $_SESSION['id_usuario_movilizacion'] . ")";
...
else
{
   ...
   function SC_fast_search($field, $arg_search, $data_search)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion_mob']['where_filter_form'] . " and (IdVehiculo = (Select IdVehiculo from vehiculos where usuario_idusuario = " . $_SESSION['id_usuario_movilizacion'] . ")) and (" . $comando . ")";
      }
      else
      {
          $sc_where = " where IdVehiculo = (Select IdVehiculo from vehiculos where usuario_idusuario = " . $_SESSION['id_usuario_movilizacion'] . ") and (" . $comando . ")";
      }
      $nmgp_select = "SELECT count(*) AS countTest from " . $this->Ini->nm_tabela . $sc_where; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nmgp_select; 
      $rt = $this->Db->Execute($nmgp_select) ; 
