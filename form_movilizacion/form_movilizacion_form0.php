...
<div class="scFormHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFormHeaderFont" style="float: left; text-transform: uppercase;"><?php if ($this->nmgp_opcao == "novo") { echo "Ingreso Hoja de Rutas y Control de Combustible y Kilometraje"; } else { echo "Ingreso Hoja de Rutas y Control de Combustible y Kilometraje"; } ?></div>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    ...
    {
        $this->nm_new_label['id_movilizacion'] = "Id Movilizacion";
    }
?>
<?php
...
<?php if ((isset($this->Embutida_form) && $this->Embutida_form) || ($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir")) { ?>
    ...
    <TD class="scFormDataOdd css_id_movilizacion_line" id="hidden_field_data_id_movilizacion" style="<?php echo $sStyleHidden_id_movilizacion; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_id_movilizacion_line" style="vertical-align: top;padding: 0px"><span id="id_read_on_id_movilizacion" class="css_id_movilizacion_line" style="<?php echo $sStyleReadLab_id_movilizacion; ?>"><?php echo $this->form_encode_input($this->id_movilizacion); ?></span><span id="id_read_off_id_movilizacion" style="<?php echo $sStyleReadInp_id_movilizacion; ?>"><input type="hidden" name="id_movilizacion" value="<?php echo $this->form_encode_input($id_movilizacion) . "\">"?><span id="id_ajax_label_id_movilizacion"><?php echo nl2br($id_movilizacion); ?></span>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   {
       $this->nm_new_label['idvehiculo'] = "Id Vehiculo";
   }
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
   $nm_img_fun_cel  = ($nm_img_fun_cel  == $this->Ini->img_fun_imp    ? $this->Ini->img_fun_par  : $this->Ini->img_fun_imp);
...
<?php  $this->movilizacion_funcionario_1 = explode(";", trim($this->movilizacion_funcionario)) ; ?>
    <TD class="scFormLabelOdd scUiLabelWidthFix css_movilizacion_funcionario_label" id="hidden_field_label_movilizacion_funcionario" style="<?php echo $sStyleHidden_movilizacion_funcionario; ?>"><span id="id_label_movilizacion_funcionario"><?php echo $this->nm_new_label['movilizacion_funcionario']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion']['php_cmp_required']['movilizacion_funcionario']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion']['php_cmp_required']['movilizacion_funcionario'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_movilizacion_funcionario_line" id="hidden_field_data_movilizacion_funcionario" style="<?php echo $sStyleHidden_movilizacion_funcionario; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_movilizacion_funcionario_line" style="vertical-align: top;padding: 0px">
...
;
   ...
   echo "</td>";
   echo "<td>";
   echo " <select class=\"sc-js-input scFormObjectOdd css_movilizacion_funcionario_obj\" style=\"\" name=\"movilizacion_funcionario_dest\"  onBlur=\"scCssBlur(this);\"  onFocus=\"scCssFocus(this);\"  size=20 multiple onDblClick=\"nm_del_sel('movilizacion_funcionario_dest', 'movilizacion_funcionario_orig', null);  \" alt=\"{type: 'select', enterTab: false}\">";
   $x = 0 ; 
   while (!empty($todo[$x])) 
   {
          $cadaselect = explode("?#?", $todo[$x]) ; 
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    ...
    {
        $this->nm_new_label['movilizacion_recorrido_vehiculo'] = "Recorrido por el Vehículo";
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
...
<TABLE align="center" id="hidden_bloco_1" class="scFormTable" width="100%" style="height: 100%;"><?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    ...
    {
        $this->nm_new_label['detalle_movilizacion'] = "detalle_movilizacion";
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_detalle_movilizacion_label" id="hidden_field_label_detalle_movilizacion" style="<?php echo $sStyleHidden_detalle_movilizacion; ?>"><span id="id_label_detalle_movilizacion"><?php echo $this->nm_new_label['detalle_movilizacion']; ?></span></TD>
    <TD class="scFormDataOdd css_detalle_movilizacion_line" id="hidden_field_data_detalle_movilizacion" style="<?php echo $sStyleHidden_detalle_movilizacion; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td width="100%" class="scFormDataFontOdd css_detalle_movilizacion_line" style="vertical-align: top;padding: 0px">
<?php
