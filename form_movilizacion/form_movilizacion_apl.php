...
//----- 
   function ini_controle()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion']['where_orig'] = " where IdVehiculo = (Select IdVehiculo from vehiculos where usuario_idusuario = " . $_SESSION['id_usuario_movilizacion'] . ")";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion']['where_pesq'] = " where IdVehiculo = (Select IdVehiculo from vehiculos where usuario_idusuario = " . $_SESSION['id_usuario_movilizacion'] . ")";
...
else
{
   ...
   function SC_fast_search($field, $arg_search, $data_search)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_movilizacion']['where_filter_form'] . " and (IdVehiculo = (Select IdVehiculo from vehiculos where usuario_idusuario = " . $_SESSION['id_usuario_movilizacion'] . ")) and (" . $comando . ")";
      }
      else
      {
