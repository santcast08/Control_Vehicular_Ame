...
<HEAD>
 <TITLE><?php if ('novo' == $this->nmgp_opcao) { echo strip_tags("" . $this->Ini->Nm_lang['lang_othr_frmi_title'] . " detalle_movilizacion"); } else { echo strip_tags("" . $this->Ini->Nm_lang['lang_othr_frmu_title'] . " detalle_movilizacion"); } ?></TITLE>
...
<div class="scFormHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFormHeaderFont" style="float: left; text-transform: uppercase;"><?php if ($this->nmgp_opcao == "novo") { echo "" . $this->Ini->Nm_lang['lang_othr_frmi_title'] . " detalle_movilizacion"; } else { echo "" . $this->Ini->Nm_lang['lang_othr_frmu_title'] . " detalle_movilizacion"; } ?></div>
 ...
 ?>
   ...
   <?php if (isset($this->nmgp_cmp_hidden['detalle_movilizacion_origen_']) && $this->nmgp_cmp_hidden['detalle_movilizacion_origen_'] == 'off') { $sStyleHidden_detalle_movilizacion_origen_ = 'display: none'; }
      ...
      if (!isset($this->nm_new_label['detalle_movilizacion_origen_'])) {
          $this->nm_new_label['detalle_movilizacion_origen_'] = "Detalle Movilizacion Origen"; } ?>
   ...
   <?php if (isset($this->nmgp_cmp_hidden['detalle_movilizacion_destino_']) && $this->nmgp_cmp_hidden['detalle_movilizacion_destino_'] == 'off') { $sStyleHidden_detalle_movilizacion_destino_ = 'display: none'; }
      ...
      if (!isset($this->nm_new_label['detalle_movilizacion_destino_'])) {
          $this->nm_new_label['detalle_movilizacion_destino_'] = "Detalle Movilizacion Destino"; } ?>
   ...
   <?php if (isset($this->nmgp_cmp_hidden['detalle_movilizacion_fecha_inicio_']) && $this->nmgp_cmp_hidden['detalle_movilizacion_fecha_inicio_'] == 'off') { $sStyleHidden_detalle_movilizacion_fecha_inicio_ = 'display: none'; }
      ...
      if (!isset($this->nm_new_label['detalle_movilizacion_fecha_inicio_'])) {
          $this->nm_new_label['detalle_movilizacion_fecha_inicio_'] = "Detalle Movilizacion Fecha Inicio"; } ?>
<?php
...
?>
   ...
   <?php if (isset($this->nmgp_cmp_hidden['detalle_movilizacion_fecha_fin_']) && $this->nmgp_cmp_hidden['detalle_movilizacion_fecha_fin_'] == 'off') { $sStyleHidden_detalle_movilizacion_fecha_fin_ = 'display: none'; }
      ...
      if (!isset($this->nm_new_label['detalle_movilizacion_fecha_fin_'])) {
          $this->nm_new_label['detalle_movilizacion_fecha_fin_'] = "Detalle Movilizacion Fecha Fin"; } ?>
<?php
...
?>
   ...
   <?php if (isset($this->nmgp_cmp_hidden['id_movilizacion_']) && $this->nmgp_cmp_hidden['id_movilizacion_'] == 'off') { $sStyleHidden_id_movilizacion_ = 'display: none'; }
      if (1 || !isset($this->nmgp_cmp_hidden['id_movilizacion_']) || $this->nmgp_cmp_hidden['id_movilizacion_'] == 'on') {
      if (!isset($this->nm_new_label['id_movilizacion_'])) {
          $this->nm_new_label['id_movilizacion_'] = "Id Movilizacion"; } ?>

    <TD class="scFormLabelOddMult css_id_movilizacion__label" id="hidden_field_label_id_movilizacion_" style="<?php echo $sStyleHidden_id_movilizacion_; ?>" > <?php echo $this->nm_new_label['id_movilizacion_'] ?> </TD>
   <?php } ?>
...
{ 
   ...
   foreach ($this->form_vert_form_detalle_movilizacion as $sc_seq_vert => $sc_lixo)
   {
       ...
       if (isset($this->Embutida_ronly) && $this->Embutida_ronly && !$Line_Add)
       {
           ...
           $this->nmgp_cmp_readonly['id_movilizacion_'] = true;
       }
       elseif ($Line_Add)
       {
           ...
           if (!isset($this->nmgp_cmp_readonly['id_movilizacion_']) || $this->nmgp_cmp_readonly['id_movilizacion_'] != "on") {$this->nmgp_cmp_readonly['id_movilizacion_'] = false;}
       }
       ...
       $id_movilizacion_ = $this->id_movilizacion_; 
       $sStyleHidden_id_movilizacion_ = '';
       if (isset($sCheckRead_id_movilizacion_))
       {
           unset($sCheckRead_id_movilizacion_);
       }
       if (isset($this->nmgp_cmp_readonly['id_movilizacion_']))
       {
           $sCheckRead_id_movilizacion_ = $this->nmgp_cmp_readonly['id_movilizacion_'];
       }
       if (isset($this->nmgp_cmp_hidden['id_movilizacion_']) && $this->nmgp_cmp_hidden['id_movilizacion_'] == 'off')
       {
           unset($this->nmgp_cmp_hidden['id_movilizacion_']);
           $sStyleHidden_id_movilizacion_ = 'display: none;';
       }
       $bTestReadOnly_id_movilizacion_ = true;
       $sStyleReadLab_id_movilizacion_ = 'display: none;';
       $sStyleReadInp_id_movilizacion_ = '';
       if (isset($this->nmgp_cmp_readonly['id_movilizacion_']) && $this->nmgp_cmp_readonly['id_movilizacion_'] == 'on')
       {
           $bTestReadOnly_id_movilizacion_ = false;
           unset($this->nmgp_cmp_readonly['id_movilizacion_']);
           $sStyleReadLab_id_movilizacion_ = '';
           $sStyleReadInp_id_movilizacion_ = 'display: none;';
       }
...
?>
   ...
   <?php if (isset($this->nmgp_cmp_hidden['id_movilizacion_']) && $this->nmgp_cmp_hidden['id_movilizacion_'] == 'off') { $sc_hidden_yes++; ?>
<input type=hidden name="id_movilizacion_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($this->id_movilizacion_) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormDataOddMult css_id_movilizacion__line" id="hidden_field_data_id_movilizacion_<?php echo $sc_seq_vert; ?>" style="<?php echo $sStyleHidden_id_movilizacion_; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOddMult css_id_movilizacion__line" style="vertical-align: top;padding: 0px">
<?php if ($bTestReadOnly_id_movilizacion_ && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["id_movilizacion_"]) &&  $this->nmgp_cmp_readonly["id_movilizacion_"] == "on") { 
...
else
{
   ...
   while (!empty($todo[$x])) 
   {
          $cadaselect = explode("?#?", $todo[$x]) ; 
          if ($cadaselect[1] == "@ ") {$cadaselect[1]= trim($cadaselect[1]); } ; 
          if (isset($this->Embutida_ronly) && $this->Embutida_ronly && isset($this->id_movilizacion__1))
          {
              foreach ($this->id_movilizacion__1 as $tmp_id_movilizacion_)
              {
                  if (trim($tmp_id_movilizacion_) === trim($cadaselect[1])) { $id_movilizacion__look .= $cadaselect[0] . '__SC_BREAK_LINE__'; }
              }
          }
          elseif (trim($this->id_movilizacion_) === trim($cadaselect[1])) { $id_movilizacion__look .= $cadaselect[0]; } 
          $x++; 
   }

?>
<input type="hidden" name="id_movilizacion_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($id_movilizacion_) . "\">" . $id_movilizacion__look . ""; ?>
<?php } else { ?>
<?php
   $todo = $this->Form_lookup_id_movilizacion_();
   $x = 0 ; 
   $id_movilizacion__look = ""; 
   while (!empty($todo[$x])) 
   {
          ...
          if (empty($id_movilizacion__look))
          {
              $id_movilizacion__look = $this->id_movilizacion_;
          }
   $x = 0; 
   echo "<span id=\"id_read_on_id_movilizacion_" . $sc_seq_vert . "\" class=\"css_id_movilizacion__line\" style=\"" .  $sStyleReadLab_id_movilizacion_ . "\">" . $this->form_encode_input($id_movilizacion__look) . "</span><span id=\"id_read_off_id_movilizacion_" . $sc_seq_vert . "\" style=\"" . $sStyleReadInp_id_movilizacion_ . "\">";
   echo " <span id=\"idAjaxSelect_id_movilizacion_" .  $sc_seq_vert . "\"><select class=\"sc-js-input scFormObjectOddMult css_id_movilizacion__obj\" style=\"\" id=\"id_sc_field_id_movilizacion_" . $sc_seq_vert . "\" name=\"id_movilizacion_" . $sc_seq_vert . "\" size=\"1\" alt=\"{type: 'select', enterTab: false}\">" ; 
   echo "\r" ; 
   while (!empty($todo[$x]) && !$nm_nao_carga) 
   {
          $cadaselect = explode("?#?", $todo[$x]) ; 
          if ($cadaselect[1] == "@ ") {$cadaselect[1]= trim($cadaselect[1]); } ; 
          echo "  <option value=\"$cadaselect[1]\"" ; 
          if (trim($this->id_movilizacion_) === trim($cadaselect[1])) 
          {
              echo " selected" ; 
          }
          if (strtoupper($cadaselect[2]) == "S") 
          {
              if (empty($this->id_movilizacion_)) 
              {
                  echo " selected" ;
              } 
           } 
...
?> 
<?php  }?>
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_id_movilizacion_<?php echo $sc_seq_vert; ?>_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_id_movilizacion_<?php echo $sc_seq_vert; ?>_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
<?php   
       ...
       if (isset($sCheckRead_id_movilizacion_))
       {
           $this->nmgp_cmp_readonly['id_movilizacion_'] = $sCheckRead_id_movilizacion_;
       }
       if ('display: none;' == $sStyleHidden_id_movilizacion_)
       {
           $this->nmgp_cmp_hidden['id_movilizacion_'] = 'off';
       }
