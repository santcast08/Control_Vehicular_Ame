...
//----- 
   function ini_controle()
   {
      ...
      if ($this->NM_ajax_flag)
      {
          ...
          if (isset($this->NM_ajax_info['param']['id_movilizacion_']))
          {
              $this->id_movilizacion_ = $this->NM_ajax_info['param']['id_movilizacion_'];
          }
      ...
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_movilizacion']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_movilizacion']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_movilizacion']['sc_outra_jan']))
      {
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_detalle_movilizacion']))
          {
               ...
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_detalle_movilizacion']['label'] = "" . $this->Ini->Nm_lang['lang_othr_frmu_title'] . " detalle_movilizacion";
...
//
   ...
   function controle()
   {
      ...
      if ($this->NM_ajax_flag && 'submit_form' == $this->NM_ajax_opcao)
      {
         ...
         if (isset($this->id_movilizacion_)) { $this->nm_limpa_alfa($this->id_movilizacion_); }
      ...
      if ($this->NM_ajax_flag && 'validate_' == substr($this->NM_ajax_opcao, 0, 9))
      {
         ...
         $Campos_Erros = array();
          ...
          if ('validate_id_movilizacion_' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'id_movilizacion_');
          }
          form_detalle_movilizacion_pack_ajax_response();
          exit;
      }
      ...
      { 
         ...
         $this->id_movilizacion_ = $GLOBALS["id_movilizacion_" . $sc_seq_vert]; 
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_movilizacion']['dados_form'][$sc_seq_vert]))
         {
             $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_movilizacion']['dados_form'][$sc_seq_vert];
         }
   ...
   function Recupera_Nome_Campo($campo) 
   {
       switch($campo)
       {
           ...
           case 'detalle_movilizacion_origen_':
               return "Detalle Movilizacion Origen";
               break;
           case 'detalle_movilizacion_destino_':
               return "Detalle Movilizacion Destino";
               break;
           case 'detalle_movilizacion_fecha_inicio_':
               return "Detalle Movilizacion Fecha Inicio";
               break;
           case 'detalle_movilizacion_fecha_fin_':
               return "Detalle Movilizacion Fecha Fin";
               break;
...
//---------------------------------------------------------
     ...
     if ('' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
      ...
      if ('' == $filtro || 'id_movilizacion_' == $filtro)
        $this->ValidateField_id_movilizacion_($Campos_Crit, $Campos_Falta, $Campos_Erros);
//-- converter datas   
          $this->nm_converte_datas();
//---
    ...
    function ValidateField_detalle_movilizacion_fecha_inicio_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              { 
                  $Campos_Crit .= "Detalle Movilizacion Fecha Inicio; " ; 
    ...
    function ValidateField_detalle_movilizacion_fecha_fin_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              { 
                  $Campos_Crit .= "Detalle Movilizacion Fecha Fin; " ; 
    ...
    function ValidateField_id_movilizacion_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
               if (!empty($this->id_movilizacion_) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_movilizacion']['Lookup_id_movilizacion_']) && !in_array($this->id_movilizacion_, $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_movilizacion']['Lookup_id_movilizacion_']))
               {
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
                   if (!isset($Campos_Erros['id_movilizacion_']))
                   {
                       $Campos_Erros['id_movilizacion_'] = array();
                   }
                   $Campos_Erros['id_movilizacion_'][] = $this->Ini->Nm_lang['lang_errm_ajax_data'];
                   if (!isset($this->NM_ajax_info['errList']['id_movilizacion_']) || !is_array($this->NM_ajax_info['errList']['id_movilizacion_']))
                   {
                       $this->NM_ajax_info['errList']['id_movilizacion_'] = array();
                   }
                   $this->NM_ajax_info['errList']['id_movilizacion_'][] = $this->Ini->Nm_lang['lang_errm_ajax_data'];
               }
    } // ValidateField_id_movilizacion_
   ...
   function ajax_return_values_all_vert()
   {
          if (isset($this->nmgp_refresh_fields) && isset($this->nmgp_refresh_row) && '' != $this->nmgp_refresh_row)
          {
              ...
              if ((isset($this->Embutida_ronly) && $this->Embutida_ronly) || $this->NM_ajax_force_values)
              {
                  ...
                  if (isset($this->NM_ajax_changed['id_movilizacion_']) && $this->NM_ajax_changed['id_movilizacion_'])
                  {
                      $this->form_vert_form_detalle_movilizacion[$this->nmgp_refresh_row]['id_movilizacion_'] = $this->id_movilizacion_;
                  }
              }
          }
...
else
{
   ...
   $nm_comando = "SELECT rutas_Origen, rutas_Origen  FROM rutas  GROUP BY rutas_Origen ORDER BY rutas_Origen";
...
else
{
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          $aLookupOrig = $aLookup;
              ...
              if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("id_movilizacion_", $this->nmgp_refresh_fields)))
              {
                  $sTmpValue = NM_charset_to_utf8($aRecData['id_movilizacion_']);
                  $aLookup = array();
 
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_movilizacion']['Lookup_id_movilizacion_']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_movilizacion']['Lookup_id_movilizacion_'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_movilizacion']['Lookup_id_movilizacion_']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_movilizacion']['Lookup_id_movilizacion_'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   $nm_comando = "SELECT Id_Movilizacion, Id_Movilizacion FROM movilizacion ORDER BY Id_Movilizacion";
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_movilizacion']['Lookup_id_movilizacion_'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          $aLookupOrig = $aLookup;
          $sSelComp = "name=\"id_movilizacion_\"";
          if (isset($this->NM_ajax_info['select_html']['id_movilizacion_']) && !empty($this->NM_ajax_info['select_html']['id_movilizacion_']))
          {
              eval("\$sSelComp = \"" . $this->NM_ajax_info['select_html']['id_movilizacion_'] . "\";");
          }
          $sLookup = '';
          foreach ($aLookup as $aOption)
          {
          ...
          $aLookup  = $sLookup;
                  $this->NM_ajax_info['fldList']['id_movilizacion_' . $sc_seq_vert] = array(
                       'row'    => $sc_seq_vert,
                       'type'    => 'select',
                       'valList' => array($sTmpValue),
               'optList' => $aLookup,
          ...
          $aLabel     = array();
          $aLabelTemp = array();
          foreach ($this->NM_ajax_info['fldList']['id_movilizacion_' . $sc_seq_vert]['valList'] as $i => $v)
          {
              $this->NM_ajax_info['fldList']['id_movilizacion_' . $sc_seq_vert]['valList'][$i] = form_detalle_movilizacion_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
              if (in_array(key($aValData), $this->NM_ajax_info['fldList']['id_movilizacion_' . $sc_seq_vert]['valList']))
              {
                  $aLabelTemp[key($aValData)] = current($aValData);
              }
          }
          foreach ($this->NM_ajax_info['fldList']['id_movilizacion_' . $sc_seq_vert]['valList'] as $iIndex => $sValue)
          {
              $aLabel[$iIndex] = (isset($aLabelTemp[$sValue])) ? $aLabelTemp[$sValue] : $sValue;
          }
          $this->NM_ajax_info['fldList']['id_movilizacion_' . $sc_seq_vert]['labList'] = $aLabel;
              }
          }
   }
...
//----------- 
   ...
   { 
      ...
      if ($this->nmgp_opcao == "alterar")
      {
          ...
          $SC_ex_upd_or = true; 
          $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_movilizacion']['dados_select'][$sc_seq_vert];
          if ($this->nmgp_dados_select['iddetalle_movilizacion_'] == $this->iddetalle_movilizacion_ &&
          ...
          else
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_movilizacion']['dados_select'][$sc_seq_vert]['id_movilizacion_'] = $this->id_movilizacion_;
          }
      }
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          { 
              ...
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
              { 
                  $comando = "UPDATE " . $this->Ini->nm_tabela . " SET detalle_movilizacion_origen = '$this->detalle_movilizacion_origen_', detalle_movilizacion_destino = '$this->detalle_movilizacion_destino_', detalle_movilizacion_fecha_inicio = #$this->detalle_movilizacion_fecha_inicio_#, detalle_movilizacion_fecha_fin = #$this->detalle_movilizacion_fecha_fin_#, Id_Movilizacion = $this->id_movilizacion_";  
              } 
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
              { 
                  $comando = "UPDATE " . $this->Ini->nm_tabela . " SET detalle_movilizacion_origen = '$this->detalle_movilizacion_origen_', detalle_movilizacion_destino = '$this->detalle_movilizacion_destino_', detalle_movilizacion_fecha_inicio = " . $this->Ini->date_delim . $this->detalle_movilizacion_fecha_inicio_ . $this->Ini->date_delim1 . ", detalle_movilizacion_fecha_fin = " . $this->Ini->date_delim . $this->detalle_movilizacion_fecha_fin_ . $this->Ini->date_delim1 . ", Id_Movilizacion = $this->id_movilizacion_";  
              } 
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_oracle))
              { 
              ...
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_informix))
              { 
                  $comando_oracle = "UPDATE " . $this->Ini->nm_tabela . " SET detalle_movilizacion_origen = '$this->detalle_movilizacion_origen_', detalle_movilizacion_destino = '$this->detalle_movilizacion_destino_', detalle_movilizacion_fecha_inicio = EXTEND('$this->detalle_movilizacion_fecha_inicio_', YEAR TO DAY), detalle_movilizacion_fecha_fin = EXTEND('$this->detalle_movilizacion_fecha_fin_', YEAR TO DAY), Id_Movilizacion = $this->id_movilizacion_";  
              } 
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
              { 
                  $comando_oracle = "UPDATE " . $this->Ini->nm_tabela . " SET detalle_movilizacion_origen = '$this->detalle_movilizacion_origen_', detalle_movilizacion_destino = '$this->detalle_movilizacion_destino_', detalle_movilizacion_fecha_inicio = " . $this->Ini->date_delim . $this->detalle_movilizacion_fecha_inicio_ . $this->Ini->date_delim1 . ", detalle_movilizacion_fecha_fin = " . $this->Ini->date_delim . $this->detalle_movilizacion_fecha_fin_ . $this->Ini->date_delim1 . ", Id_Movilizacion = $this->id_movilizacion_";  
          ...
          $this->detalle_movilizacion_destino_ = $this->detalle_movilizacion_destino__before_qstr;
              ...
              if     (isset($NM_val_form) && isset($NM_val_form['id_movilizacion_'])) { $this->id_movilizacion_ = $NM_val_form['id_movilizacion_']; }
              elseif (isset($this->id_movilizacion_)) { $this->nm_limpa_alfa($this->id_movilizacion_); }
              ...
              $this->nmgp_refresh_fields = array_diff(array('iddetalle_movilizacion_', 'detalle_movilizacion_origen_', 'detalle_movilizacion_destino_', 'detalle_movilizacion_fecha_inicio_', 'detalle_movilizacion_fecha_fin_', 'id_movilizacion_'), $aDoNotUpdate);
              $this->ajax_return_values();
              ...
              if (isset($this->Embutida_ronly) && $this->Embutida_ronly)
              {
                  ...
                  $this->NM_ajax_info['readOnly']['id_movilizacion_' . $this->nmgp_refresh_row] = 'on';
      ...
      { 
          ...
          { 
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
              { 
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (detalle_movilizacion_origen, detalle_movilizacion_destino, detalle_movilizacion_fecha_inicio, detalle_movilizacion_fecha_fin, Id_Movilizacion) VALUES ('$this->detalle_movilizacion_origen_', '$this->detalle_movilizacion_destino_', #$this->detalle_movilizacion_fecha_inicio_#, #$this->detalle_movilizacion_fecha_fin_#, $this->id_movilizacion_)"; 
              }
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
              { 
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (" . $NM_cmp_auto . "detalle_movilizacion_origen, detalle_movilizacion_destino, detalle_movilizacion_fecha_inicio, detalle_movilizacion_fecha_fin, Id_Movilizacion) VALUES (" . $NM_seq_auto . "'$this->detalle_movilizacion_origen_', '$this->detalle_movilizacion_destino_', " . $this->Ini->date_delim . $this->detalle_movilizacion_fecha_inicio_ . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->detalle_movilizacion_fecha_fin_ . $this->Ini->date_delim1 . ", $this->id_movilizacion_)"; 
              }
              ...
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_informix))
              {
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (" . $NM_cmp_auto . "detalle_movilizacion_origen, detalle_movilizacion_destino, detalle_movilizacion_fecha_inicio, detalle_movilizacion_fecha_fin, Id_Movilizacion) VALUES (" . $NM_seq_auto . "'$this->detalle_movilizacion_origen_', '$this->detalle_movilizacion_destino_', EXTEND('$this->detalle_movilizacion_fecha_inicio_', YEAR TO DAY), EXTEND('$this->detalle_movilizacion_fecha_fin_', YEAR TO DAY), $this->id_movilizacion_)"; 
              }
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
              {
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (" . $NM_cmp_auto . "detalle_movilizacion_origen, detalle_movilizacion_destino, detalle_movilizacion_fecha_inicio, detalle_movilizacion_fecha_fin, Id_Movilizacion) VALUES (" . $NM_seq_auto . "'$this->detalle_movilizacion_origen_', '$this->detalle_movilizacion_destino_', " . $this->Ini->date_delim . $this->detalle_movilizacion_fecha_inicio_ . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->detalle_movilizacion_fecha_fin_ . $this->Ini->date_delim1 . ", $this->id_movilizacion_)"; 
...
else
{
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          foreach ($aLookup as $aValData)
          {
              if (key($aValData) == form_detalle_movilizacion_pack_protect_string(NM_charset_to_utf8($this->id_movilizacion_)))
              {
                  $sLabelTemp = current($aValData);
              }
          }
          $tmpLabel_id_movilizacion_ = $sLabelTemp;
                  $this->NM_ajax_info['fldList']['id_movilizacion_' . $this->nmgp_refresh_row]['type']    = 'select';
                  $this->NM_ajax_info['fldList']['id_movilizacion_' . $this->nmgp_refresh_row]['valList'] = array($this->form_encode_input(NM_charset_to_utf8($this->id_movilizacion_)));
                  $this->NM_ajax_info['fldList']['id_movilizacion_' . $this->nmgp_refresh_row]['labList'] = array($tmpLabel_id_movilizacion_);

                  if ((isset($this->Embutida_form) && $this->Embutida_form) && (!isset($this->Embutida_ronly) || !$this->Embutida_ronly))
                  {
                      if (!isset($this->NM_ajax_info['readOnly']['id_movilizacion_' . $this->nmgp_refresh_row]))
                      {
                          $this->NM_ajax_info['readOnly']['id_movilizacion_' . $this->nmgp_refresh_row] = "off";
                      }
                  }
                  elseif (isset($this->Embutida_ronly) && $this->Embutida_ronly)
                  {
...
//---------- 
   ...
   { 
      ...
      { 
          $nmgp_select = "SELECT iddetalle_movilizacion, detalle_movilizacion_origen, detalle_movilizacion_destino, str_replace (convert(char(10),detalle_movilizacion_fecha_inicio,102), '.', '-') + ' ' + convert(char(8),detalle_movilizacion_fecha_inicio,20), str_replace (convert(char(10),detalle_movilizacion_fecha_fin,102), '.', '-') + ' ' + convert(char(8),detalle_movilizacion_fecha_fin,20), Id_Movilizacion from " . $this->Ini->nm_tabela . $sc_where . $sc_order_by; 
      } 
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
      { 
          $nmgp_select = "SELECT iddetalle_movilizacion, detalle_movilizacion_origen, detalle_movilizacion_destino, convert(char(23),detalle_movilizacion_fecha_inicio,121), convert(char(23),detalle_movilizacion_fecha_fin,121), Id_Movilizacion from " . $this->Ini->nm_tabela . $sc_where . $sc_order_by; 
      } 
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_oracle))
      { 
          $nmgp_select = "SELECT iddetalle_movilizacion, detalle_movilizacion_origen, detalle_movilizacion_destino, detalle_movilizacion_fecha_inicio, detalle_movilizacion_fecha_fin, Id_Movilizacion from " . $this->Ini->nm_tabela . $sc_where . $sc_order_by; 
      } 
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_informix))
      { 
          $nmgp_select = "SELECT iddetalle_movilizacion, detalle_movilizacion_origen, detalle_movilizacion_destino, EXTEND(detalle_movilizacion_fecha_inicio, YEAR TO DAY), EXTEND(detalle_movilizacion_fecha_fin, YEAR TO DAY), Id_Movilizacion from " . $this->Ini->nm_tabela . $sc_where . $sc_order_by; 
      } 
      else 
      { 
          $nmgp_select = "SELECT iddetalle_movilizacion, detalle_movilizacion_origen, detalle_movilizacion_destino, detalle_movilizacion_fecha_inicio, detalle_movilizacion_fecha_fin, Id_Movilizacion from " . $this->Ini->nm_tabela . $sc_where . $sc_order_by; 
...
else
{
   ...
   function Form_lookup_id_movilizacion_()
   {
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_movilizacion']['Lookup_id_movilizacion_']))
{
...
else
{
   ...
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $nm_numeric[] = "iddetalle_movilizacion";$nm_numeric[] = "id_movilizacion";
   ...
   function SC_lookup_detalle_movilizacion_origen_($condicao, $campo)
   {
       ...
       $campo_orig = $campo;
       $campo  = substr($this->Db->qstr($campo), 1, -1);
       $nm_comando = "SELECT rutas_Origen, rutas_Origen FROM rutas WHERE (rutas_Origen LIKE '%$campo%')" ; 
       if ($condicao == "ii")
       {
