  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_control_hoja_usuario_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate listado_c_movilizacion
  function do_ajax_control_hoja_usuario_mob_validate_listado_c_movilizacion()
  {
    var nomeCampo_listado_c_movilizacion = "listado_c_movilizacion";
    var var_listado_c_movilizacion = scAjaxGetFieldSelect(nomeCampo_listado_c_movilizacion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_hoja_usuario_mob_validate_listado_c_movilizacion(var_listado_c_movilizacion, var_script_case_init, do_ajax_control_hoja_usuario_mob_validate_listado_c_movilizacion_cb);
  } // do_ajax_control_hoja_usuario_mob_validate_listado_c_movilizacion

  function do_ajax_control_hoja_usuario_mob_validate_listado_c_movilizacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "listado_c_movilizacion";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_hoja_usuario_mob_validate_listado_c_movilizacion_cb
  // ---------- Form
  function do_ajax_control_hoja_usuario_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_control_hoja_usuario_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_listado_c_movilizacion = scAjaxGetFieldSelect("listado_c_movilizacion");
    ...
    scAjaxProcOn();
    x_ajax_control_hoja_usuario_mob_submit_form(var_listado_c_movilizacion, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_control_hoja_usuario_mob_submit_form_cb);
  } // do_ajax_control_hoja_usuario_mob_submit_form

  function do_ajax_control_hoja_usuario_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
  ...
  } // do_ajax_control_hoja_usuario_mob_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_control_hoja_usuario_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_control_hoja_usuario_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['control_hoja_usuario_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_control_hoja_usuario_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
...
{
?>
    do_ajax_control_hoja_usuario_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_control_hoja_usuario_mob_navigate_form_cb
  function sc_hide_control_hoja_usuario_mob_form()
  {
    for (var block_id in ajax_block_id) {
      $("#div_" + ajax_block_id[block_id]).hide();
    }
  } // sc_hide_control_hoja_usuario_mob_form
  ...
  ajax_field_list[0] = "listado_c_movilizacion";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "listado_c_movilizacion": {"label": "Conductor", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "listado_c_movilizacion": new Array()
  };
  ajax_field_mult["listado_c_movilizacion"][1] = "listado_c_movilizacion";

  var ajax_field_id = {
    "listado_c_movilizacion": new Array("hidden_field_label_listado_c_movilizacion", "hidden_field_data_listado_c_movilizacion")
  };

  var ajax_read_only = {
    "listado_c_movilizacion": "off"
  };
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("listado_c_movilizacion" == sIndex)
    {
