...
<HEAD>
 <TITLE><?php if ('novo' == $this->nmgp_opcao) { echo strip_tags("" . $this->Ini->Nm_lang['lang_othr_frmi_title'] . " usuario"); } else { echo strip_tags("" . $this->Ini->Nm_lang['lang_othr_frmu_title'] . " usuario"); } ?></TITLE>
...
<div class="scFormHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFormHeaderFont" style="float: left; text-transform: uppercase;"><?php if ($this->nmgp_opcao == "novo") { echo "" . $this->Ini->Nm_lang['lang_othr_frmi_title'] . " usuario"; } else { echo "" . $this->Ini->Nm_lang['lang_othr_frmu_title'] . " usuario"; } ?></div>
