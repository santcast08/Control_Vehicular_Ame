...
$_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("control_hoja_usuario") . "/control_hoja_usuario_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['control_hoja_usuario']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['control_hoja_usuario'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
if (isset($_SESSION['scriptcase']['sc_apl_seg']['control_hoja_usuario']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['control_hoja_usuario']) == "on")
{
    $Menu_menuData['data'] .= "item_9|..|" . $nm_var_lab[8] . "|Menu_form_php.php?sc_item_menu=item_9&sc_apl_menu=control_hoja_usuario&sc_apl_link=" . urlencode($Menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['Menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[8] . "||" . $this->Menu_target('_self') . "|" . "\n";
}
else
{
...
$Menu_menuData['data'] .= "item_12|.|" . $this->Nm_lang['lang_menu_security'] . "||" . $this->Nm_lang['lang_menu_security'] . "||_self|\n";
...
{
    $Menu_menuData['data'] .= "item_13|..|" . $this->Nm_lang['lang_list_users'] . "|Menu_form_php.php?sc_item_menu=item_13&sc_apl_menu=app_grid_sec_users&sc_apl_link=" . urlencode($Menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['Menu']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_list_users'] . "||" . $this->Menu_target('_self') . "|" . "\n";
}
else
{
    $Menu_menuData['data'] .= "item_13|..|" . $this->Nm_lang['lang_list_users'] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['app_grid_sec_apps']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_grid_sec_apps']) == "on")
{
    $Menu_menuData['data'] .= "item_14|..|" . $this->Nm_lang['lang_list_apps'] . "|Menu_form_php.php?sc_item_menu=item_14&sc_apl_menu=app_grid_sec_apps&sc_apl_link=" . urlencode($Menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['Menu']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_list_apps'] . "||" . $this->Menu_target('_self') . "|" . "\n";
}
else
{
    $Menu_menuData['data'] .= "item_14|..|" . $this->Nm_lang['lang_list_apps'] . "||||_self|disabled\n";
}
...
{
    $Menu_menuData['data'] .= "item_15|..|" . $this->Nm_lang['lang_list_groups'] . "|Menu_form_php.php?sc_item_menu=item_15&sc_apl_menu=app_grid_sec_groups&sc_apl_link=" . urlencode($Menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['Menu']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_list_groups'] . "||" . $this->Menu_target('_self') . "|" . "\n";
}
else
{
    $Menu_menuData['data'] .= "item_15|..|" . $this->Nm_lang['lang_list_groups'] . "||||_self|disabled\n";
}
...
{
    $Menu_menuData['data'] .= "item_22|..|" . $this->Nm_lang['lang_list_users_x_groups'] . "|Menu_form_php.php?sc_item_menu=item_22&sc_apl_menu=app_grid_sec_users_groups&sc_apl_link=" . urlencode($Menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['Menu']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_list_users_x_groups'] . "||" . $this->Menu_target('_self') . "|" . "\n";
}
else
{
    $Menu_menuData['data'] .= "item_22|..|" . $this->Nm_lang['lang_list_users_x_groups'] . "||||_self|disabled\n";
}
...
{
    $Menu_menuData['data'] .= "item_16|..|" . $this->Nm_lang['lang_list_apps_x_groups'] . "|Menu_form_php.php?sc_item_menu=item_16&sc_apl_menu=app_search_sec_groups&sc_apl_link=" . urlencode($Menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['Menu']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_list_apps_x_groups'] . "||" . $this->Menu_target('_self') . "|" . "\n";
}
else
{
    $Menu_menuData['data'] .= "item_16|..|" . $this->Nm_lang['lang_list_apps_x_groups'] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['app_sync_apps']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_sync_apps']) == "on")
{
    $Menu_menuData['data'] .= "item_17|..|" . $this->Nm_lang['lang_list_sync_apps'] . "|Menu_form_php.php?sc_item_menu=item_17&sc_apl_menu=app_sync_apps&sc_apl_link=" . urlencode($Menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['Menu']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_list_sync_apps'] . "||" . $this->Menu_target('_self') . "|" . "\n";
}
else
{
    $Menu_menuData['data'] .= "item_17|..|" . $this->Nm_lang['lang_list_sync_apps'] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['app_logged_users']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_logged_users']) == "on")
{
    $Menu_menuData['data'] .= "item_20|..|" . $this->Nm_lang['lang_logged_users'] . "|Menu_form_php.php?sc_item_menu=item_20&sc_apl_menu=app_logged_users&sc_apl_link=" . urlencode($Menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['Menu']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_logged_users'] . "||" . $this->Menu_target('_self') . "|" . "\n";
}
else
{
    $Menu_menuData['data'] .= "item_20|..|" . $this->Nm_lang['lang_logged_users'] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['app_change_pswd']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_change_pswd']) == "on")
{
    $Menu_menuData['data'] .= "item_18|..|" . $this->Nm_lang['lang_change_pswd'] . "|Menu_form_php.php?sc_item_menu=item_18&sc_apl_menu=app_change_pswd&sc_apl_link=" . urlencode($Menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['Menu']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_change_pswd'] . "||" . $this->Menu_target('_self') . "|" . "\n";
}
else
{
    $Menu_menuData['data'] .= "item_18|..|" . $this->Nm_lang['lang_change_pswd'] . "||||_self|disabled\n";
}
...
$str_disabled = "N";
$str_link = "Menu_form_php.php?sc_item_menu=item_9&sc_apl_menu=control_hoja_usuario&sc_apl_link=" . urlencode($Menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['Menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['control_hoja_usuario']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['control_hoja_usuario']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "Menu_form_php.php?sc_item_menu=item_13&sc_apl_menu=app_grid_sec_users&sc_apl_link=" . urlencode($Menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['Menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app_grid_sec_users']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_grid_sec_users']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "Menu_form_php.php?sc_item_menu=item_14&sc_apl_menu=app_grid_sec_apps&sc_apl_link=" . urlencode($Menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['Menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app_grid_sec_apps']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_grid_sec_apps']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "Menu_form_php.php?sc_item_menu=item_15&sc_apl_menu=app_grid_sec_groups&sc_apl_link=" . urlencode($Menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['Menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app_grid_sec_groups']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_grid_sec_groups']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "Menu_form_php.php?sc_item_menu=item_22&sc_apl_menu=app_grid_sec_users_groups&sc_apl_link=" . urlencode($Menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['Menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app_grid_sec_users_groups']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_grid_sec_users_groups']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "Menu_form_php.php?sc_item_menu=item_16&sc_apl_menu=app_search_sec_groups&sc_apl_link=" . urlencode($Menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['Menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app_search_sec_groups']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_search_sec_groups']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "Menu_form_php.php?sc_item_menu=item_17&sc_apl_menu=app_sync_apps&sc_apl_link=" . urlencode($Menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['Menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app_sync_apps']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_sync_apps']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "Menu_form_php.php?sc_item_menu=item_20&sc_apl_menu=app_logged_users&sc_apl_link=" . urlencode($Menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['Menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app_logged_users']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_logged_users']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "Menu_form_php.php?sc_item_menu=item_18&sc_apl_menu=app_change_pswd&sc_apl_link=" . urlencode($Menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['Menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app_change_pswd']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_change_pswd']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
