...
if ($this->Db)
{
    $this->Db->Close(); 
      ...
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("control_hoja_usuario") . "/?nm_run_menu=1&nm_apl_menu=Menu&script_case_init=" . $this->Gera_sc_init($this->sc_menu_item) . "&script_case_session=" . session_id() . "";
      }
